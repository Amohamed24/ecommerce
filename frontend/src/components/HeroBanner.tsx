...
const HeroBanner = () => {
  ...
  const textAlignment = current.textPosition === 'left' ? 'items-start text-left pl-16' : 'items-end text-right pr-16';
  ...
  return (
    <div className="relative w-full h-[500px] overflow-hidden">
      ...
      {/* Text Content */}
      <div className={`absolute inset-0 flex flex-col justify-center ${textAlignment} text-white`}>
        <h2 className="text-5xl font-light tracking-wider mb-4">{current.title}</h2>
        <p className="text-xl mb-8 max-w-md">{current.description}</p>
